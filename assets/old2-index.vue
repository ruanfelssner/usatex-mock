  ...
  <div class="container">
    <div class="row py-5 justify-content-center">
      <div class="col-auto">
        ...
        <select v-model="backgroundSelected" @change="changeImg">
    ...
    <div class="row justify-content-center">
      <div class="col-8">
        ...
        <VueCropper
          ...
          drag-mode="crop"
          :zoomable="true"
          @cropstart="cropEvent('cropstart', $event)"
        />
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    changeImg () {
      this.$refs.cropper.replace(this.backgroundSelected.img)
    },
    zoom (percent) {
